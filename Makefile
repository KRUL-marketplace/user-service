...
generate-user-service-api:
	...
	--go-grpc_out=pkg/user-service --go-grpc_opt=paths=source_relative \
	--plugin=protoc-gen-go-grpc=bin/protoc-gen-go-grpc \
	--validate_out lang=go:pkg/user-service --validate_opt=paths=source_relative \
	--plugin=protoc-gen-validate=bin/protoc-gen-validate \
	--grpc-gateway_out=pkg/user-service --grpc-gateway_opt=paths=source_relative \
...
generate:
	mkdir -p pkg/swagger
	make generate-user-service-api
